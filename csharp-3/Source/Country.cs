...
namespace Codenation.Challenge
{
    public class Country
    {
        ...
        {
            // return 10 elements from the querry order by greater extension
            return BrazilianStates().OrderByDescending(State => State.Extension).Take(10).ToArray();
        }
        // Function that returs all the Brazilian States 
        private State[] BrazilianStates()
        {
